...
export function Thread() {
  ...
  const startRecording = async () => {
    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        try {
          ...
          if (response.ok) {
            ...
            toast.error('Error: Could not transcribe audio.');
          }
        } catch (error) {
          console.error('Error sending audio to server:', error);
          toast.error('Error: Could not send audio to server.');
        }
      };
      ...
      toast.error('Error: Could not access microphone. Please grant permission.');
    }
  };
              ...
              <div className="sticky flex flex-col items-center gap-8 bottom-0 bg-white">
                {!chatStarted && (
                  <div className="flex gap-3 items-center">
                    <LangGraphLogoSVG width={38} height={38} />
                        ...
                        <TooltipIconButton
                          ...
                          className={cn(
                            ...
                            isRecording
                              ...
                              : "hover:bg-gray-100",
                            isPressed && !isRecording ? "bg-gray-200" : "",
                          )}
                        >
